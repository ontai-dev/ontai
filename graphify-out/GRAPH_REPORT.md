# Graph Report - /home/saigha01/ontai  (2026-05-06)

## Corpus Check
- Large corpus: 371 files · ~404,540 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2923 nodes · 4670 edges · 243 communities detected
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 428 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Conductor Agent Mode|Conductor Agent Mode]]
- [[_COMMUNITY_Platform CRD Types|Platform CRD Types]]
- [[_COMMUNITY_RBAC Policy Engine|RBAC Policy Engine]]
- [[_COMMUNITY_Pack Execution Pipeline|Pack Execution Pipeline]]
- [[_COMMUNITY_Etcd Maintenance|Etcd Maintenance]]
- [[_COMMUNITY_Lineage Tracking|Lineage Tracking]]
- [[_COMMUNITY_Session Progress Docs|Session Progress Docs]]
- [[_COMMUNITY_CAPI Cluster Lifecycle|CAPI Cluster Lifecycle]]
- [[_COMMUNITY_Node Patch Operations|Node Patch Operations]]
- [[_COMMUNITY_S3 Backup Operations|S3 Backup Operations]]
- [[_COMMUNITY_Schedule Reconcilers|Schedule Reconcilers]]
- [[_COMMUNITY_Machine Config Restore|Machine Config Restore]]
...
2. `RunAgent()` - 31 edges
3. `ONT Platform Backlog` - 30 edges
4. `conductor CODEBASE.md` - 25 edges
5. `compileBootstrap()` - 23 edges
6. `ONT Platform Progress` - 22 edges
7. `failureResult()` - 20 edges
8. `tbx()` - 19 edges
9. `main()` - 18 edges
10. `unstructuredString()` - 18 edges

## Surprising Connections (you probably didn't know these)
- `PermissionSnapshot lifecycle (generate-sign-deliver-verify-ack)` --semantically_similar_to--> `ed25519 signing protocol for PackInstance CRs`  [INFERRED] [semantically similar]
  guardian/guardian-design.md → domain-core/config/relationships/conductor-signs-clusterpack.yaml
- `Human-at-Boundary Principle` --semantically_similar_to--> `Humans Remain In Loop at Production Boundary`  [INFERRED] [semantically similar]
  AGENTS.md → branding/philosophy.md
- `INV-007: Destructive Operations Require Human Approval` --semantically_similar_to--> `Humans Remain In Loop at Production Boundary`  [INFERRED] [semantically similar]
  CLAUDE.md → branding/philosophy.md
- `INV-009: RunnerConfig Operator-Generated, Never Human-Authored` --semantically_similar_to--> `All Infrastructure Operations Declarative, Versioned, Auditable`  [INFERRED] [semantically similar]
  CLAUDE.md → branding/philosophy.md
...
## Communities (270 total, 90 thin omitted)

### Community 0 - "Conductor Agent Mode"
Cohesion: 0.05
Nodes (32): ClusterResetReconciler, extractObservedVersion(), DriftSignalReconciler, etcdCapability(), resolveEtcdBackupS3Secret(), EtcdMaintenanceReconciler, MachineConfigBackupReconciler, maintenanceBundleCapability() (+24 more)

### Community 1 - "Platform CRD Types"
Cohesion: 0.05
Nodes (58): EndpointsFromTalosconfig(), NodeContext(), bootstrapHandler, clusterResetHandler, credentialRotateHandler, etcdBackupHandler, etcdMaintenanceHandler, etcdRestoreHandler (+50 more)

### Community 2 - "RBAC Policy Engine"
Cohesion: 0.05
...
### Community 3 - "Pack Execution Pipeline"
Cohesion: 0.07
...
### Community 4 - "Etcd Maintenance"
Cohesion: 0.05
Nodes (57): APIGroupSweepController, BootstrapController, Bootstrap RBAC window, cluster-maximum PermissionSet (Layer 2 ceiling), ClusterRBACPolicyReconciler controller, CNPG-backed persistent EPG and audit store, Conductor Operator, DomainRelationship: conductor-signs-clusterpack (+49 more)

### Community 5 - "Lineage Tracking"
Cohesion: 0.05
Nodes (15): APIEndpoint, NodeRole, SeamInfrastructureCluster, SeamInfrastructureClusterList, SeamInfrastructureClusterSpec, SeamInfrastructureClusterStatus, SeamInfrastructureMachine, SeamInfrastructureMachineList (+7 more)

### Community 6 - "Session Progress Docs"
Cohesion: 0.06
Nodes (15): NewFederationClient(), clusterStatus, ForceCodecOption(), FederationClient, federationJSONCodec, FederationServer, federationServiceServer, _federationStreamHandler() (+7 more)

### Community 7 - "CAPI Cluster Lifecycle"
Cohesion: 0.06
Nodes (12): TalosEtcdBackupSchedule, TalosEtcdBackupScheduleList, TalosEtcdBackupScheduleSpec, TalosEtcdBackupScheduleStatus, TalosMachineConfigBackupSchedule, TalosMachineConfigBackupScheduleList, TalosMachineConfigBackupScheduleSpec, TalosMachineConfigBackupScheduleStatus (+4 more)

### Community 8 - "Node Patch Operations"
Cohesion: 0.06
...
### Community 9 - "S3 Backup Operations"
Cohesion: 0.06
...
### Community 10 - "Schedule Reconcilers"
Cohesion: 0.09
Nodes (11): ClusterMaintenanceStatus, ClusterResetStatus, EtcdMaintenanceStatus, HardeningProfile, HardeningProfileList, HardeningProfileSpec, HardeningProfileStatus, MaintenanceBundleStatus (+3 more)

### Community 11 - "Machine Config Restore"
Cohesion: 0.06
...
Cohesion: 0.13
Nodes (16): CheckPermissionRequest, CheckPermissionResponse, EffectiveRuleDTO, ExplainDecisionRequest, ExplainDecisionResponse, ListPermissionsRequest, ListPermissionsResponse, LocalService (+8 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (9): InfrastructureCAPIConfig, InfrastructureClusterPackSpec, InfrastructureClusterPackStatus, InfrastructureLineageIndexSpec, InfrastructurePackBuildStatus, InfrastructureRunnerConfigSpec, InfrastructureRunnerConfigStatus, InfrastructureTalosClusterSpec (+1 more)
...
Cohesion: 0.08
Nodes (8): DescendantEntry, InfrastructureLineageIndex, InfrastructureLineageIndexList, InfrastructureLineageIndexRootBinding, InfrastructureLineageIndexStatus, InfrastructurePolicyBindingStatus, LineageRetentionPolicy, OutcomeType

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (8): InfrastructureRunnerConfig, InfrastructureRunnerConfigList, RunnerCapabilityEntry, RunnerConfigStep, RunnerConfigStepResult, RunnerOperationalHistoryEntry, RunnerPhaseConfig, RunnerStepResultPhase
...
Cohesion: 0.11
Nodes (22): APP-CORE (9 CRDs under core.ontai.dev scaffold), CAPI-E2E (SeamInfrastructureCluster/Machine lifecycle e2e), T-23 DriftSignalReconciler (closed 2026-05-05), T-24 Decision H cascade (closed 2026-05-05), DOCUMENTATION-CLUSTER (sovereign cluster for lineage graph), G-BL-IDP-POLLING (IdentityProviderReconciler OIDC group polling), G-BL-SELF-AUDIT-MISSING (rbac.would_deny audit event absent), G-BL-SNAPSHOT-ALIAS (snapshot-management PermissionSnapshot covers ccs-mgmt) (+14 more)
...
Cohesion: 0.14
Nodes (6): DomainEventStatus, DomainIdentityStatus, DomainOwnershipStatus, DomainPolicyStatus, DomainRelationshipStatus, DomainResourceStatus

### Community 36 - "Community 36"
Cohesion: 0.11
Nodes (6): collect_test_files(), main(), Return all *_test.go files and Go files under test/ directories., JobSpec, JobSpecBuilder, SecretVolume

### Community 37 - "Community 37"
Cohesion: 0.14
Nodes (6): GuardianStatus, IdentityBindingStatus, PermissionSetSpec, PrincipalPermissionEntry, RBACPolicyStatus, RBACProfileSpec
...
Cohesion: 0.11
Nodes (5): InfrastructurePackReceipt, InfrastructurePackReceiptList, InfrastructurePackReceiptSpec, InfrastructurePackReceiptStatus, PackReceiptDeployedResource

### Community 40 - "Community 40"
Cohesion: 0.13
Nodes (18): conductor CLAUDE.md, Management Cluster Bootstrap Sequence (compiler bootstrap/launch/enable, three steps, Platform not involved), Federation Channel Contract (bidirectional gRPC between management and tenant Conductors), Import-mode tenant onboarding gRPC handshake sequence (tenant dials MGMT_ENDPOINT, management pushes PermissionSnapshot), ONTAR (Operator Native Task Application Runtime) - architectural thesis, ONTAR Five Intent Categories (Execution, Connectivity, Configuration, Lifecycle, Audit), ONTAR governance chain (Guardian -> Conductor -> ONTAR at pod boundary), ONTAR Six Invariants (nothing undeclared executes; hash-stable graphs; phase authority) (+10 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (19): CONDUCTOR-BL-CAPABILITY-WATCH (RunnerConfig Watch instead of poll), K8S-DRIFT-CONFIRM (drift-k8s-version-ccs-dev corrective action), TCOR-SIZE-BOUND (AppendOperationRecord size guard), Alpha Release v1.9.3-alpha.1, drift-k8s-version-ccs-dev DriftSignal, make envtest-setup (K8s 1.32.x kubebuilder-envtest), Graphify Production Graph (graphify-out/graph.json), Graphify Test Graph (graphify-tests-out/graph.json) (+11 more)
...
Cohesion: 0.15
Nodes (13): BuildManifest(), NewCapabilityPublisher(), LeaderCallbacks, RunLeaderElection(), SetTalosClusterReady(), onLeaderStart(), PermissionServiceEnabled(), RunAgent() (+5 more)
...
Cohesion: 0.12
Nodes (5): PermissionRule, PermissionSet, PermissionSetList, PermissionSetStatus, Verb
...
Cohesion: 0.12
Nodes (5): PermissionSnapshotReceipt, PermissionSnapshotReceiptList, PermissionSnapshotReceiptSpec, PermissionSnapshotReceiptStatus, SyncStatus
...
Cohesion: 0.17
Nodes (16): app-core Codebase Reference, Decision 1: Sealed Causal Chain Is Spec Field, Decision 2: Two-Layer Lineage Schema, Decision 3: LineageIndex Controller-Authored Only, Decision 5: Creation Rationale Vocabulary Is Seam Core Enum, Decision G: seam-core Owns All Cross-Operator CRD Schemas, app-core Repository, domain-core Repository (+8 more)
...
Cohesion: 0.17
Nodes (15): PLATFORM-BL-CAPI-TENANT-ONBOARDING (closed 2026-05-06), PLATFORM-BL-KUBECONFIG-CANONICAL (closed 2026-05-06), PLATFORM-BL-MACHINECONFIG-BACKUP (closed 2026-05-06), PLATFORM-BL-TALOSCONFIG-ONTYSYSTEM-REMOVE (closed 2026-05-06), ensureCAPIKubeconfig helper, ensureExecutorTalosconfig (seam-tenant-{cluster} only), ensureTenantOnboarding (CAPI step 8.5), MachineConfigBackupReconciler (+7 more)

### Community 64 - "Community 64"
Cohesion: 0.14
Nodes (4): DomainComplianceStatus, DomainIdentityList, DomainOwnership, DomainPolicy
...
Cohesion: 0.2
Nodes (9): main(), setupManagementControllers(), setupRoleControllers(), setupSharedControllers(), setupTenantControllers(), NewService(), NewNamespaceEnforcementRegistry(), NewWebhookModeGate() (+1 more)
...
Cohesion: 0.14
Nodes (4): Guardian, GuardianList, GuardianSpec, WebhookMode
...
Cohesion: 0.15
Nodes (9): DomainComplianceSpec, DomainEventSpec, DomainIdentitySpec, DomainOwnershipSpec, DomainPolicySpec, DomainRelationshipSpec, DomainResourceSpec, DomainTransactionSpec (+1 more)
...
Cohesion: 0.22
Nodes (7): auditSeq(), lineageRef(), writeAudit(), ComplianceCheckResult, ProfileValidationResult, CheckProfilePolicyCompliance(), ValidateRBACProfileSpec()
...
Cohesion: 0.35
Nodes (11): conductor CODEBASE.md, Conductor execute mode (Kueue Jobs on management cluster), etcdBackupHandler (Talos EtcdSnapshot + seekable bytes.NewReader for MinIO upload), hardeningApplyHandler (HardeningProfile machineConfigPatches via unstructuredList per patch), kubeUpgradeHandler (GetMachineConfig + mergeYAMLPatch + ApplyConfiguration no-reboot), Named Capabilities (Conductor execute vocabulary), Pack-deploy execution flow (PackExecution -> Kueue Job -> executeSplitPath), S3StorageClientAdapter (AWS SDK v2 wrapper, MinIO HTTP seekable-stream requirement) (+3 more)

### Community 100 - "Community 100"
Cohesion: 0.25
Nodes (11): Conductor agent mode (long-running Deployment in ont-system), INV-026: Private key on management conductor only; tenants verify but never sign, KubernetesVersionDriftLoop (tenant: reads kubeletVersion, compares to spec.kubernetesVersion, emits DriftSignal), namespaceTerminating guard in PackReceiptDriftLoop (skips drift for resources in terminating namespaces), PackInstancePullLoop (tenant: pulls signed Secrets, verifies Ed25519, upserts PackReceipt), PackReceiptDriftLoop (tenant-side drift detection against deployedResources), RBACPolicyPullLoop (tenant: pulls cluster-policy RBACPolicy from management cluster, SSA-patches into ont-system), RBACProfilePullLoop (tenant: pulls conductor-tenant RBACProfile from management cluster, SSA-patches into ont-system) (+3 more)
...
Cohesion: 0.32
Nodes (8): PLATFORM-BL-MACHINECONFIG-RESTORE (closed 2026-05-06), CapabilityMachineConfigRestore constant (pkg/runnerlib/constants.go), MachineConfigRestoreReconciler, machineConfigRestoreHandler (Conductor capability), Session 25 (machineconfig-restore + backup schedule reconcilers), TalosEtcdBackupSchedule CRD, TalosMachineConfigBackupSchedule CRD, TalosMachineConfigRestore CRD
...
Cohesion: 0.4
Nodes (6): AppResourceProfile CRD, InfrastructureClusterPack CRD, Kueue Integration (pack-deploy Jobs), InfrastructurePackInstance CRD, Wrapper Operator, DomainResource Primitive
...
Cohesion: 0.47
Nodes (6): PLATFORM-BL-HARDENINGPROFILE-MERGE (closed 2026-05-06), ensureBootstrapHardening (ONT-native hardening path), ensureTalosConfigTemplate (CAPI hardening path), HardeningApplied condition (seam-core/pkg/conditions), hardeningProfileRef field (InfrastructureTalosClusterSpec), Session 24b (HardeningProfile bootstrap support)
...
Cohesion: 0.5
Nodes (4): CapabilityPublisher (management: publishes 17 named capabilities to RunnerConfig status), InfrastructureRunnerConfig CRD (infrastructure.ontai.dev/v1alpha1), pkg/runnerlib shared library (CapabilityManifest, JobSpecBuilder, OperationResultSpec, generators), conductor README.md

### Community 195 - "Community 195"
Cohesion: 0.5
Nodes (4): DAY2-OPS-TENANT (remaining live day-2 validation gaps), WRAPPER-BL-ENVTEST-GC (TestPackInstance OwnerRefCascade needs live cluster), ccs-dev cluster (10.20.0.20, unreachable), ccs-mgmt cluster (partially degraded, cp3 NotReady)
...
Cohesion: 0.67
Nodes (3): GUARDIAN-AUTO-RBAC APIGroupSweepController (closed 2026-05-05), APIGroupSweepController (guardian/internal/controller), Session 22 (six cleanup items)

## Knowledge Gaps
- **374 isolated node(s):** `Return all *_test.go files and Go files under test/ directories.`, `RBACReadyChecker`, `RootBindingRef`, `DescendantRef`, `DomainIdentitySpec` (+369 more)
...
- **Why does `buildPackOperationResultSpec()` connect `Community 104` to `Community 65`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `PackResultStatus` connect `Community 104` to `Community 21`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Are the 27 inferred relationships involving `RunAgent()` (e.g. with `NewWebhookServer()` and `NewEnforcementGate()`) actually correct?**
  _`RunAgent()` has 27 INFERRED edges - model-reasoned connections that need verification._
- **Are the 4 inferred relationships involving `compileBootstrap()` (e.g. with `.String()` and `resolveKubeconfigPath()`) actually correct?**
  _`compileBootstrap()` has 4 INFERRED edges - model-reasoned connections that need verification._
- **What connects `Return all *_test.go files and Go files under test/ directories.`, `RBACReadyChecker`, `RootBindingRef` to the rest of the system?**
  _374 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Conductor Agent Mode` be split into smaller, more focused modules?**
  _Cohesion score 0.05 - nodes in this community are weakly interconnected._
- **Should `Platform CRD Types` be split into smaller, more focused modules?**
  _Cohesion score 0.05 - nodes in this community are weakly interconnected._